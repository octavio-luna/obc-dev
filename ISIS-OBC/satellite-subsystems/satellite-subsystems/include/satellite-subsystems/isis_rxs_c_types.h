 ...
 */
typedef struct __attribute__((__packed__)) _isis_rxs_c__get_frame__from_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_rxs_c__get_frame_count_length__from_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_rxs_c__get_full_frame__from_t
{
