 ...
 */
typedef struct __attribute__((__packed__)) _isis_vu_d__get_frame__from_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_vu_d__get_full_frame__from_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_vu_d__send_frame_with_callsigns__to_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_vu_d__set_beacon__to_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_vu_d__set_beacon_with_callsigns__to_t
{
    uint16_t interval; /*!< Interval of beacon transmission */
    uint8_t from_callsign[7]; /*!< The new 7 characters from callsign. */
    uint8_t to_callsign[7]; /*!< The new 7 characters to callsign. */
