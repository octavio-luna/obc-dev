 ...
 *
 * Generated ICD version: 1.4
 * Generated from: isis_aocs_common.yaml
 */
...
#include <stdint.h>
    ...
    #else
        #include <assert.h>
        typedef struct __attribute__((__packed__)) _isis_aocs_test
        {
...
typedef enum __attribute__ ((__packed__)) isis_aocs__fpdb_index_t
{
    ...
    isis_aocs__fpdb_index__aocs_mtm_int_bias_est_enabled = 261u,
    ...
    isis_aocs__fpdb_index__aocs_mtm_ext_bias_est_enabled = 268u,
    ...
    isis_aocs__fpdb_index__aocs_scg_raw_bias_est_enabled = 285u,
    ...
    isis_aocs__fpdb_index__aocs_scg_filt_bias_est_enabled = 292u,
 ...
 */
typedef enum __attribute__ ((__packed__)) isis_aocs__tlm_flags_t
{
    isis_aocs__tlm_flags__relative = 0u,
    isis_aocs__tlm_flags__absolute = 1u,
    isis_aocs__tlm_flags__at_pps = 2u,
} isis_aocs__tlm_flags_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__imtq_config_t
{
    ...
    {
        uint8_t detumble_frequency; /*!< "To be defined" */
        uint8_t current_feedback; /*!< "To be defined" */
        uint8_t mtm_select; /*!< "To be defined" */
        uint8_t int_mtm_integration_time; /*!< "To be defined" */
        uint8_t ext_mtm_integration_time; /*!< "To be defined" */
        uint8_t int_mtm_axis_map[3]; /*!< "To be defined" */
        uint8_t ext_mtm_axis_map[3]; /*!< "To be defined" */
        int16_t map_temperatures[7]; /*!< "To be defined" */
        int16_t map_max_x[7]; /*!< "To be defined" */
        int16_t map_max_y[7]; /*!< "To be defined" */
        int16_t map_max_z[7]; /*!< "To be defined" */
        int16_t coil_current_bias[3]; /*!< "To be defined" */
        int16_t coil_current_premul[3]; /*!< "To be defined" */
        int16_t coil_current_postdiv[3]; /*!< "To be defined" */
        int16_t coil_temp_bias[3]; /*!< "To be defined" */
        int16_t coil_temp_premul[3]; /*!< "To be defined" */
        int16_t coil_temp_postdiv[3]; /*!< "To be defined" */
        uint16_t coil_total_current_limit; /*!< "To be defined" */
        int32_t closed_loop_feedback_gain[3]; /*!< "To be defined" */
        float bdot_gain; /*!< "To be defined" */
        float mtm_correction_matrix[9]; /*!< "To be defined" */
        float mtm_correction_bias[3]; /*!< "To be defined" */
        float mtm_adapt_filter_sensitivity; /*!< "To be defined" */
        float mtm_adapt_filter_weight; /*!< "To be defined" */
        float coil_effective_area[3]; /*!< "To be defined" */
        uint8_t reserved[2]; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_reset_cause_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_onoff_t firewall : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t obl : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t pin : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t bor : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t sft : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t iwdg : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t wwdg : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t lwpr : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_system_error_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_error_flag_t spi1_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t spi2_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t i2c2_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t usart1_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t can1_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t gyro_ovr_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t flash_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t ugakf_init_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t ugakf_update_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t sram2_parity_error : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_system_state_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_system_mode_t system_mode : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t gyro_data_ready : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t config_changed : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t ugakf_reinit_flag : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t sram2_parity_enabled : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_ugakf_bias_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        float gyro1_bias_est_x; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro1_bias_est_y; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro1_bias_est_z; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro2_bias_est_x; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro2_bias_est_y; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro2_bias_est_z; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro3_bias_est_x; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro3_bias_est_y; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro3_bias_est_z; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        float gyro1_bias_cov_x; /*!< "To be defined" */
        float gyro1_bias_cov_y; /*!< "To be defined" */
        float gyro1_bias_cov_z; /*!< "To be defined" */
        float gyro2_bias_cov_x; /*!< "To be defined" */
        float gyro2_bias_cov_y; /*!< "To be defined" */
        float gyro2_bias_cov_z; /*!< "To be defined" */
        float gyro3_bias_cov_x; /*!< "To be defined" */
        float gyro3_bias_cov_y; /*!< "To be defined" */
        float gyro3_bias_cov_z; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_ugakf_rate_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        double angular_rate_est_x; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        double angular_rate_est_y; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        double angular_rate_est_z; /*!< "To be defined" \note conversion: eng. value [in °/s] = 57.2957795130823 * raw */
        double angular_rate_cov1_x; /*!< "To be defined" */
        double angular_rate_cov1_y; /*!< "To be defined" */
        double angular_rate_cov1_z; /*!< "To be defined" */
        double angular_rate_cov2_x; /*!< "To be defined" */
        double angular_rate_cov2_y; /*!< "To be defined" */
        double angular_rate_cov2_z; /*!< "To be defined" */
        double angular_rate_cov3_x; /*!< "To be defined" */
        double angular_rate_cov3_y; /*!< "To be defined" */
        double angular_rate_cov3_z; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_hk_t
{
    ...
    {
        uint64_t timestamp; /*!< Unix timestamp when the data was requested from the subsystem */
        isis_aocs__scg_reply_header_t reply_header; /*!< "To be defined" */
        uint32_t system_uptime; /*!< "To be defined" */
        int8_t mcu_temp; /*!< "To be defined" */
        int8_t gyro1_temp; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
        int8_t gyro2_temp; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
        int8_t gyro3_temp; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
        uint8_t current; /*!< "To be defined" */
        uint16_t voltage; /*!< "To be defined" \note conversion: eng. value [in V] = 0.001 * raw */
        isis_aocs__scg_system_error_t bitmap1; /*!< "To be defined" */
        isis_aocs__scg_system_state_t bitmap2; /*!< "To be defined" */
        isis_aocs__scg_reset_cause_t reset_cause; /*!< "To be defined" */
    } fields;
} isis_aocs__scg_hk_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_fw_error_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_error_flag_t borw_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw0_flash_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw0_coro_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw0_corw_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw1_flash_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw1_coro_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw1_corw_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw2_flash_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw2_coro_error : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_error_flag_t fw2_corw_error : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_raw_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_onoff_t SCG_1 : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t SCG_2 : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t SCG_3 : 1; /*!< "To be defined" */
        uint8_t padding : 5; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_system_flags_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_enum_onoff_t ugakf_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t temp_comp_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t misa_comp_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t swdt_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t spike_removal_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t turnon_bias_removal_enabled : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_system_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_system_flags_t system_flags; /*!< "To be defined" */
        int8_t update_rate_ugakf; /*!< "To be defined" */
        int8_t update_rate_fast; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_ugakf_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        float r_gyro1_x; /*!< "To be defined" */
        float r_gyro1_y; /*!< "To be defined" */
        float r_gyro1_z; /*!< "To be defined" */
        float r_gyro2_x; /*!< "To be defined" */
        float r_gyro2_y; /*!< "To be defined" */
        float r_gyro2_z; /*!< "To be defined" */
        float r_gyro3_x; /*!< "To be defined" */
        float r_gyro3_y; /*!< "To be defined" */
        float r_gyro3_z; /*!< "To be defined" */
        float q_rate; /*!< "To be defined" */
        float q_bias; /*!< "To be defined" */
        float p_rate; /*!< "To be defined" */
        float p_bias; /*!< "To be defined" */
        float gyro1_mean_x; /*!< "To be defined" */
        float gyro1_mean_y; /*!< "To be defined" */
        float gyro1_mean_z; /*!< "To be defined" */
        float gyro2_mean_x; /*!< "To be defined" */
        float gyro2_mean_y; /*!< "To be defined" */
        float gyro2_mean_z; /*!< "To be defined" */
        float gyro3_mean_x; /*!< "To be defined" */
        float gyro3_mean_y; /*!< "To be defined" */
        float gyro3_mean_z; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__scg_raw_config_t raw_config; /*!< "To be defined" */
        isis_aocs__scg_system_config_t system_config; /*!< "To be defined" */
        isis_aocs__scg_gyro_config_t gyro_config; /*!< "To be defined" */
        isis_aocs__scg_ugakf_config_t ugakf_config; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_temperature_coefficients_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        float coeff_0[9]; /*!< "To be defined" */
        float coeff_1[9]; /*!< "To be defined" */
        float coeff_2[9]; /*!< "To be defined" */
        float coeff_3[9]; /*!< "To be defined" */
        float coeff_4[9]; /*!< "To be defined" */
        float coeff_5[9]; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__lensrnd_correction_table_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint32_t reserved; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__cubewheel_array_hk_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t padding1; /*!< "To be defined" */
        ...
        uint8_t padding2; /*!< "To be defined" */
        ...
        uint8_t padding3; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__af_rw25_config_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t reserved[11]; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__af_rw25_array_tlm_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t padding0[8]; /*!< "To be defined" */
        int32_t speed1; /*!< RW speed \note conversion: eng. value [in rpm] = 0.25 * raw */
        uint8_t padding1[8]; /*!< "To be defined" */
        int32_t speed2; /*!< RW speed \note conversion: eng. value [in rpm] = 0.25 * raw */
        uint8_t padding2[8]; /*!< "To be defined" */
        int32_t speed3; /*!< RW speed \note conversion: eng. value [in rpm] = 0.25 * raw */
        uint8_t padding3[8]; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__rw_hk_t
{
    ...
    {
        uint64_t timestamp; /*!< Unix timestamp when the data was requested from the subsystem */
        uint8_t wheel[48]; /*!< "To be defined" */
    } fields;
} isis_aocs__rw_hk_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__hdrm_hk_t
{
    ...
    {
        uint64_t timestamp; /*!< Unix timestamp when the data was requested from the subsystem */
        isis_aocs__hdrm_state_t state : 1; /*!< "To be defined" */
        isis_aocs__hdrm_stage_t stage : 7; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__novatel_rx_status_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__novatel_rxstatus_error_t dram_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t firmware_valid : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t rom_status : 1; /*!< "To be defined" */
        uint8_t reserved_1 : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t esn_access_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t auth_code_status : 1; /*!< "To be defined" */
        uint8_t reserved_2 : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t supply_voltage_status : 1; /*!< "To be defined" */
        uint8_t reserved_3 : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t temperature_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t minos_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t pll_rf_status : 1; /*!< "To be defined" */
        uint8_t reserved_4 : 3; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t nvm_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t sw_res_lim_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t model_valid_recv : 1; /*!< "To be defined" */
        uint8_t reserved_5 : 2; /*!< "To be defined" */
        uint8_t remote_loading_begun : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t export_restriction : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t safe_mode : 1; /*!< "To be defined" */
        uint8_t reserved_6a : 1; /*!< "To be defined" */
        uint8_t reserved_6b : 7; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t component_hardware_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t rxstatus_error : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t temperature_status_2 : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t supply_voltage_status_2 : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_power_t primary_antenna_power : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t lna_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_antenna_t antenna_status : 2; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t cpu_overload : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t com_tx_buffer_overrun : 1; /*!< "To be defined" */
        uint8_t reserved_7 : 2; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t link_overrun : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t input_overrun : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t aux_tx_overrun : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t agc_out_of_range : 1; /*!< "To be defined" */
        uint8_t jammer_detected : 1; /*!< "To be defined" */
        uint8_t ins_reset : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t imu_comm_status : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_valid_t almanac : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_valid_t position_solution : 1; /*!< "To be defined" */
        uint8_t position_fixed : 1; /*!< "To be defined" */
        uint8_t clock_steering_enabled : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_valid_t clock_model : 1; /*!< "To be defined" */
        uint8_t ext_osc_locked : 1; /*!< "To be defined" */
        isis_aocs__novatel_rxstatus_error_t software_resource : 1; /*!< "To be defined" */
        uint8_t version : 2; /*!< "To be defined" */
        uint8_t tracking_mode : 1; /*!< "To be defined" */
        uint8_t digital_filtering_enabled : 1; /*!< "To be defined" */
        uint8_t aux3_event : 1; /*!< "To be defined" */
        uint8_t aux2_event : 1; /*!< "To be defined" */
        uint8_t aux1_event : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__novatel_binheader_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        uint8_t sync_bytes[3]; /*!< "To be defined" */
        uint8_t header_length; /*!< "To be defined" */
        uint16_t message_id; /*!< "To be defined" */
        uint8_t message_type; /*!< "To be defined" */
        uint8_t port; /*!< "To be defined" */
        uint16_t message_length; /*!< "To be defined" */
        uint16_t sequence; /*!< "To be defined" */
        uint8_t idletime; /*!< "To be defined" */
        isis_aocs__novatel_time_fix_status_t time_status; /*!< "To be defined" */
        uint16_t gps_week; /*!< "To be defined" */
        uint32_t gps_week_ms; /*!< "To be defined" */
        uint32_t receiver_status; /*!< "To be defined" */
        uint16_t reserved; /*!< "To be defined" */
        uint16_t sw_build; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__novatel_time_msg_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__novatel_binheader_t binheader; /*!< "To be defined" */
        uint32_t clkstatus; /*!< "To be defined" */
        double offset_rxclock; /*!< "To be defined" */
        double offset_rxclock_std; /*!< "To be defined" */
        double offset_utc; /*!< "To be defined" */
        uint32_t utc_year; /*!< "To be defined" */
        uint8_t utc_month; /*!< "To be defined" */
        uint8_t utc_day; /*!< "To be defined" */
        uint8_t utc_hour; /*!< "To be defined" */
        uint8_t utc_min; /*!< "To be defined" */
        uint32_t utc_msec; /*!< "To be defined" */
        uint32_t utc_status; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__novatel_bestxyz_msg_t
{
    ...
    {
        isis_aocs__novatel_binheader_t binheader; /*!< "To be defined" */
        uint32_t position_solstatus; /*!< "To be defined" */
        uint32_t position_type; /*!< "To be defined" */
        double position_x; /*!< "To be defined" */
        double position_y; /*!< "To be defined" */
        double position_z; /*!< "To be defined" */
        float stddev_pos_x; /*!< "To be defined" */
        float stddev_pos_y; /*!< "To be defined" */
        float stddev_pos_z; /*!< "To be defined" */
        uint32_t velocity_solstatus; /*!< "To be defined" */
        uint32_t velocity_type; /*!< "To be defined" */
        double velocity_x; /*!< "To be defined" */
        double velocity_y; /*!< "To be defined" */
        double velocity_z; /*!< "To be defined" */
        float stddev_vel_x; /*!< "To be defined" */
        float stddev_vel_y; /*!< "To be defined" */
        float stddev_vel_z; /*!< "To be defined" */
        uint8_t basestation_id[4]; /*!< "To be defined" */
        float vlatency; /*!< "To be defined" */
        float diff_age; /*!< "To be defined" */
        float solution_age; /*!< "To be defined" */
        uint8_t sats_tracked; /*!< "To be defined" */
        uint8_t sats_used; /*!< "To be defined" */
        uint8_t sats_l1e1b1; /*!< "To be defined" */
        uint8_t sats_multifreq; /*!< "To be defined" */
        uint8_t reserved; /*!< "To be defined" */
        uint8_t solution_status_ext; /*!< "To be defined" */
        uint8_t mask_gal_bei; /*!< "To be defined" */
        uint8_t mask_gps_glo; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__auriga_fpga_status_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint16_t head1_current; /*!< OH0 current */
...
typedef union __attribute__((__packed__)) _isis_aocs__iobc_sv_hk_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint16_t temperature; /*!< "To be defined" \note conversion: eng. value [in °C] = -0.29802 * raw + 191.098*/
        uint16_t voltage_3v3_in; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0048875855 * raw */
        uint16_t voltage_3v3; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0048875855 * raw */
        uint16_t voltage_2v5; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0024437928 * raw */
        uint16_t voltage_1v8; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0024437928 * raw */
        uint16_t voltage_1v0; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0024437928 * raw */
        uint16_t voltage_rtc; /*!< "To be defined" \note conversion: eng. value [in V] = 0.0048875855 * raw */
        uint16_t current_3v3_in; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.3470186 * raw */
        uint16_t current_1v8; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1221896 * raw */
        uint16_t current_1v0; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1637341 * raw */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__auriga_hk_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        isis_aocs__auriga_oh_state_t OHState1 : 5; /*!< Current state for OH1 */
        isis_aocs__auriga_oh_state_t OHState2 : 5; /*!< Current state for OH2 */
        isis_aocs__auriga_oh_state_t Reserved : 6; /*!< Reserved */
        ...
        isis_aocs__auriga_oh_temp_alarm_t OH2TemperatureAlarm : 1; /*!< OH1 temperature alarm */
...
typedef union __attribute__((__packed__)) _isis_aocs__enpulsion_fusestatus_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__enpulsion_recoverablefuse_t min_board_temperature : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t max_board_temperature : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t max_housing_temperature : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_reservoir_temperature : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t min_bus_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t max_bus_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t min_driver_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_recoverablefuse_t max_driver_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_bus_current : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_emitter_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_emitter_current : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_emitter_power : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_extractor_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_extractor_current : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_extractor_power : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_heater_voltage : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_heater_current : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_heater_power : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_neutralizer_bridge_current : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t max_neutralizer_power : 1; /*!< "To be defined" */
        isis_aocs__enpulsion_criticalfuse_t broken_neutralizer_filament : 1; /*!< "To be defined" */
        uint8_t padding1 : 3; /*!< "To be defined" */
        uint8_t padding2; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__enpulsion_registermap_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        uint8_t firmware_version_major; /*!< "To be defined" */
        uint8_t firmware_version_minor; /*!< "To be defined" */
        uint16_t serial_number; /*!< "To be defined" */
        uint16_t reset_counter; /*!< "To be defined" */
        uint32_t fuse_mask; /*!< "To be defined" */
        uint32_t fuse_status; /*!< "To be defined" */
        isis_aocs__enpulsion_opmode_t op_mode; /*!< "To be defined" */
        isis_aocs__enpulsion_status_t status; /*!< "To be defined" */
        uint16_t thrust_ref; /*!< "To be defined" \note conversion: eng. value [in µN] = 0.1 * raw */
        uint16_t thrust; /*!< "To be defined" \note conversion: eng. value [in µN] = 0.1 * raw */
        uint16_t specific_impulse_ref; /*!< "To be defined" */
        uint16_t specific_impulse; /*!< "To be defined" */
        uint16_t bus_volt; /*!< "To be defined" */
        uint16_t driver_volt; /*!< "To be defined" */
        uint16_t bus_current; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1 * raw */
        isis_aocs__enpulsion_emittermode_t emitter_mode; /*!< "To be defined" */
        uint16_t emitter_volt_ref; /*!< "To be defined" */
        uint16_t emitter_volt; /*!< "To be defined" */
        uint16_t emitter_curr_ref; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.1 * raw */
        uint16_t emitter_curr; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.1 * raw */
        uint16_t emitter_pow_ref; /*!< "To be defined" */
        uint16_t emitter_pow; /*!< "To be defined" */
        uint8_t emitter_duty_cycle_ref; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        uint8_t emitter_duty_cycle; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        isis_aocs__enpulsion_extractormode_t extractor_mode; /*!< "To be defined" */
        uint16_t extractor_volt_ref; /*!< "To be defined" */
        uint16_t extractor_volt; /*!< "To be defined" */
        uint16_t extractor_curr_ref; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.01 * raw */
        uint16_t extractor_curr; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.01 * raw */
        uint16_t extractor_pow_ref; /*!< "To be defined" \note conversion: eng. value [in mW] = 0.1 * raw */
        uint16_t extractor_pow; /*!< "To be defined" \note conversion: eng. value [in mW] = 0.1 * raw */
        uint8_t extractor_duty_cycle_ref; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        uint8_t extractor_duty_cycle; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        isis_aocs__enpulsion_heatermode_t heater_mode; /*!< "To be defined" */
        uint16_t heater_volt_ref; /*!< "To be defined" */
        uint16_t heater_volt; /*!< "To be defined" */
        uint16_t heater_curr_ref; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1 * raw */
        uint16_t heater_curr; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1 * raw */
        uint16_t heater_pow_ref; /*!< "To be defined" \note conversion: eng. value [in mW] = 1 * raw */
        uint16_t heater_pow; /*!< "To be defined" \note conversion: eng. value [in mW] = 1 * raw */
        uint8_t heater_duty_cycle_ref; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        uint8_t heater_duty_cycle; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        isis_aocs__enpulsion_neutralizermode_t neutralizer_mode; /*!< "To be defined" */
        isis_aocs__enpulsion_neutralizerfilament_t neutralizer_filament_ref; /*!< "To be defined" */
        isis_aocs__enpulsion_neutralizerfilament_t neutralizer_filament; /*!< "To be defined" */
        isis_aocs__enpulsion_neutralizerbias_t neutralizer_bias_ref; /*!< "To be defined" */
        isis_aocs__enpulsion_neutralizerbias_t neutralizer_bias; /*!< "To be defined" */
        uint16_t neutralizer_bias_volt; /*!< "To be defined" \note conversion: eng. value [in mV] = 10 * raw */
        uint16_t neutralizer_curr_ref; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1 * raw */
        uint16_t neutralizer_curr; /*!< "To be defined" \note conversion: eng. value [in mA] = 0.1 * raw */
        uint16_t neutralizer_pow_ref; /*!< "To be defined" \note conversion: eng. value [in mW] = 1 * raw */
        uint16_t neutralizer_pow; /*!< "To be defined" \note conversion: eng. value [in mW] = 1 * raw */
        uint8_t neutralizer_duty_cycle_ref; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        uint8_t neutralizer_duty_cycle; /*!< "To be defined" \note conversion: eng. value [in percent] = 0.392156862745098 * raw */
        uint16_t beam_curr_ref; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.1 * raw */
        uint16_t beam_curr; /*!< "To be defined" \note conversion: eng. value [in µA] = 0.1 * raw */
        isis_aocs__enpulsion_temperaturemode_t temperature_mode; /*!< "To be defined" */
        uint16_t reservoir_temp_ref; /*!< "To be defined" \note conversion: eng. value [in K] = 0.01 * raw */
        uint16_t reservoir_temp; /*!< "To be defined" \note conversion: eng. value [in K] = 0.01 * raw */
        uint16_t housing_temp; /*!< "To be defined" \note conversion: eng. value [in K] = 0.01 * raw */
        uint16_t board_temp; /*!< "To be defined" \note conversion: eng. value [in K] = 0.01 * raw */
        uint16_t thermal_elec_volt; /*!< "To be defined" */
        uint16_t thermopile_calibration; /*!< "To be defined" */
        uint16_t neutralizer_overcomp; /*!< "To be defined" \note conversion: eng. value = 0.001 * raw */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__thrustme_i2t5_error_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        uint8_t reserved : 1; /*!< "To be defined" */
...
typedef union __attribute__((__packed__)) _isis_aocs__thrustme_tlm_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        uint16_t data_length; /*!< "To be defined" */
        ...
        isis_aocs__thrustme_i2t5_status_t status; /*!< "To be defined" */
        uint8_t vendor_defined; /*!< "To be defined" */
        isis_aocs__thrustme_i2t5_error_t error_code; /*!< "To be defined" */
        uint16_t voltage_supply; /*!< "To be defined" \note conversion: eng. value [in V] = 0.01 * raw */
        uint16_t current_consumption; /*!< "To be defined" \note conversion: eng. value [in A] = 0.01 * raw */
        int16_t temperature; /*!< "To be defined" \note conversion: eng. value [in °C] = 0.1 * raw */
        int16_t vendor_defined0; /*!< "To be defined" */
        int16_t vendor_defined1; /*!< "To be defined" */
        int16_t vendor_defined2; /*!< "To be defined" */
        uint16_t vendor_defined3; /*!< "To be defined" */
        uint16_t vendor_defined4; /*!< "To be defined" */
        uint16_t vendor_defined5; /*!< "To be defined" */
        uint16_t vendor_defined6; /*!< "To be defined" */
        uint8_t vendor_defined7; /*!< "To be defined" */
        uint8_t vendor_defined8; /*!< "To be defined" */
        uint8_t vendor_defined9; /*!< "To be defined" */
...
typedef union __attribute__((__packed__)) _isis_aocs__tm_hk_t
{
    ...
    {
        uint64_t timestamp; /*!< Unix timestamp when the data was requested from the subsystem */
        isis_aocs__thrustme_tlm_t tlm; /*!< "To be defined" */
        uint8_t padding[64]; /*!< "To be defined" */
    } fields;
} isis_aocs__tm_hk_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__thruster_hk_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__thruster_generic_hk_t data; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__mcu_reset_cause_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        uint8_t padding : 1; /*!< "To be defined" */
...
typedef union __attribute__((__packed__)) _isis_aocs__euler_angles_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        float roll; /*!< Roll angle \note conversion: eng. value [in °] = 57.2957795130823 * raw */
...
typedef union __attribute__((__packed__)) _isis_aocs__subsystem_power_state_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__subsys_power_t system : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t obc : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t adc : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t imtq : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t mtm_ext : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t scg : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t rw : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t rw1 : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t rw2 : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t rw3 : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t rw4 : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t hdrm : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t gnss : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t str : 1; /*!< "To be defined" */
        isis_aocs__subsys_power_t thr : 1; /*!< "To be defined" */
        uint8_t reserved : 1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__subsystem_state_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint32_t reserved : 6; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__measurement_data_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        float RW[4]; /*!< Wheel speeds \note conversion: eng. value [in rpm] = 9.54929658551372 * raw */
...
typedef union __attribute__((__packed__)) _isis_aocs__ephemeris_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        float tle_age; /*!< TLE age \note conversion: eng. value [in h] = 0.000277777777777778 * raw */
...
typedef union __attribute__((__packed__)) _isis_aocs__novatel_log_config_item_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__novatel_msg_id_t msg_id; /*!< "To be defined" */
        isis_aocs__novatel_trigger_type_t trigger : 3; /*!< "To be defined" */
        uint8_t padding : 2; /*!< "To be defined" */
        isis_aocs__novatel_msg_type_t msg_type : 2; /*!< "To be defined" */
        uint16_t period; /*!< "To be defined" \note conversion: eng. value = 0.05 * raw */
        uint16_t offset; /*!< "To be defined" \note conversion: eng. value = 0.05 * raw */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__subsystem_bitfield_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__subsys_system_t system : 1; /*!< "To be defined" */
        isis_aocs__subsys_obc_t obc : 1; /*!< "To be defined" */
        isis_aocs__subsys_adc_t adc : 1; /*!< "To be defined" */
        isis_aocs__subsys_imtq_t imtq : 1; /*!< "To be defined" */
        isis_aocs__subsys_mtm_ext_t mtm_ext : 1; /*!< "To be defined" */
        isis_aocs__subsys_scg_t scg : 1; /*!< "To be defined" */
        isis_aocs__subsys_rwa_t rwa : 1; /*!< "To be defined" */
        isis_aocs__subsys_rw1_t rw1 : 1; /*!< "To be defined" */
        isis_aocs__subsys_rw2_t rw2 : 1; /*!< "To be defined" */
        isis_aocs__subsys_rw3_t rw3 : 1; /*!< "To be defined" */
        isis_aocs__subsys_rw4_t rw4 : 1; /*!< "To be defined" */
        isis_aocs__subsys_hdrm_t hdrm : 1; /*!< "To be defined" */
        isis_aocs__subsys_gnss_t gnss : 1; /*!< "To be defined" */
        isis_aocs__subsys_str_t str : 1; /*!< "To be defined" */
        isis_aocs__subsys_thr_t thr : 1; /*!< "To be defined" */
    } fields;
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_gnss_uart_write_read__to_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_i2c_write_read__to_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_mtm_ext_spi_write_read__to_t
{
    uint8_t bus; /*!< SPI bus */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_rs485_write_read__to_t
{
    uint8_t write_size; /*!< Number of bytes to write */
    uint8_t read_size; /*!< Number of bytes to read */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_spi_write_read__to_t
{
    uint8_t bus; /*!< SPI bus */
    isis_aocs__gpio_port_t ncs_port; /*!< SPI nCS port */
    uint8_t ncs_pin; /*!< SPI nCS pin */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__dbg_uart_write_read__to_t
{
    uint8_t bus; /*!< UART Bus */
    uint8_t write_size; /*!< Number of bytes to write */
    uint8_t read_size; /*!< Number of bytes to read */
...
typedef union __attribute__((__packed__)) _isis_aocs__dump_telemetry__to_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint32_t entry_flags : 2; /*!< What the entry number refers to; 0: RELATIVE, 1: ABSOLUTE, 2: AT_PPS */
        uint32_t entry : 30; /*!< TLM entry number */
        uint16_t count; /*!< Number of entries to dump */
        uint16_t skip; /*!< Number of entries to skip */
        char filename[33]; /*!< Filename of the dump */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__enp_ramp_register__to_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t start_addr; /*!< "To be defined" */
        uint8_t length; /*!< Size of the register in bytes; only 1 or 2 are supported */
        uint16_t start_value; /*!< "To be defined" */
        uint16_t end_value; /*!< "To be defined" */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__enp_script_uplink__to_t
{
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__enp_write_register__to_t
{
    uint8_t password[8]; /*!< Thruster password */
    uint8_t start_addr; /*!< "To be defined" */
    uint8_t length; /*!< "To be defined" */
    uint8_t* write_data; /*!< "To be defined" (maximum length: 110 elements) */
...
typedef union __attribute__((__packed__)) _isis_aocs__get_control_target__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        float primary_target_params[2]; /*!< Primary target parameters \note conversion: eng. value [in °] = 57.2957795130823 * raw */
        float primary_target_altitude; /*!< Primary target altitude if type is WGS84 */
        float secondary_target_params[2]; /*!< Primary target parameters \note conversion: eng. value [in °] = 57.2957795130823 * raw */
        float secondary_target_altitude; /*!< Primary target altitude if type is WGS84 */
        float primary_body_axis[2]; /*!< Primary body axis azimuth/elevation \note conversion: eng. value [in °] = 57.2957795130823 * raw */
        float secondary_body_axis[2]; /*!< Primary body axis azimuth/elevation \note conversion: eng. value [in °] = 57.2957795130823 * raw */
...
typedef union __attribute__((__packed__)) _isis_aocs__get_current_general_telemetry__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t padding : 2; /*!< "To be defined" */
        isis_aocs__mcu_reset_cause_t mcu_reset_cause; /*!< "To be defined" */
        ...
        int16_t threaded_error_code; /*!< Threaded command result code */
...
/*!
 * Union for storing the parameters sent by get_fault_log.
 */
typedef union __attribute__((__packed__)) _isis_aocs__get_fault_log__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
        uint32_t entry_flags : 2; /*!< What the entry number refers to; 0: RELATIVE, 1: ABSOLUTE */
        uint32_t entry : 30; /*!< Entry number of the first list entry. RELATIVE will count backwards from this; ABSOLUTE upwards */
    } fields;
} isis_aocs__get_fault_log__to_t;
...
/*!
 * Union for storing the parameters sent by get_general_telemetry.
 */
typedef union __attribute__((__packed__)) _isis_aocs__get_general_telemetry__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__get_general_telemetry__to_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__get_param_operating_mode_subsys_auto_power__from_t
{
    ...
    {
        isis_aocs__get_param_response_t result; /*!< Result code */
        isis_aocs__subsystem_bitfield_t data; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__get_param_sensors__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t reserved_1 : 6; /*!< Reserved for future use */
        uint16_t reserved_2; /*!< Reserved for future use */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__get_param_thr__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        uint8_t padding1[8]; /*!< Padding */
        uint8_t padding2[224]; /*!< Padding */
        uint8_t data_size; /*!< How many Bytes are in data */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__get_param_tle__from_t
{
    ...
    {
        isis_aocs__get_param_response_t result; /*!< Result code */
        float inc; /*!< "To be defined" */
        float RAAN; /*!< "To be defined" */
        float e; /*!< "To be defined" */
        float argp; /*!< "To be defined" */
        float ma; /*!< "To be defined" */
        double mm; /*!< "To be defined" */
        float BSTAR; /*!< "To be defined" */
        uint8_t EPOCH_year; /*!< "To be defined" */
        double EPOCH_day; /*!< "To be defined" */
    } fields;
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__imtq_set_bypass__to_t
{
...
/*!
 * Union for storing the parameters sent by retrieve_actuation_output.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_actuation_output__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
        isis_aocs__tlm_flags_t entry_flags : 2; /*!< What the entry number refers to */
        uint32_t entry : 30; /*!< TLM entry number */
    } fields;
} isis_aocs__retrieve_actuation_output__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_actuation_state.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_actuation_state__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_actuation_state__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_aocs_int_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_aocs_int_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_aocs_int_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_aocs_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_aocs_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_aocs_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_control_output.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_control_output__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_control_output__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_cubewheel_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_cubewheel_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_cubewheel_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_enp_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_enp_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_enp_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_ephemeris.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_ephemeris__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_ephemeris__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_euler_angles.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_euler_angles__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_euler_angles__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_gnss_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_gnss_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_gnss_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_imtq_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_imtq_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_imtq_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_measurements.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_measurements__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_measurements__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_power_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_power_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_power_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_processed_sensor_data.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_processed_sensor_data__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_processed_sensor_data__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_rw25_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_rw25_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_rw25_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_scg_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_scg_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_scg_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_state_estimate.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_state_estimate__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_state_estimate__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_str_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_str_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_str_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_subsystem_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_subsystem_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_subsystem_tlm__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_system_status.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_system_status__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_system_status__to_t;
...
/*!
 * Union for storing the parameters sent by retrieve_thr_tlm.
 */
typedef union __attribute__((__packed__)) _isis_aocs__retrieve_thr_tlm__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__retrieve_thr_tlm__to_t;
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__rw_set_bypass__to_t
{
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_get_fw_status__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__generic_error_code_t error_code; /*!< Result code */
        isis_aocs__scg_reply_header_t reply_header; /*!< "To be defined" */
        uint8_t fw_index; /*!< "To be defined" */
        uint32_t borw_count; /*!< "To be defined" */
        uint32_t fw0_size; /*!< "To be defined" */
        uint16_t fw0_crc16; /*!< "To be defined" */
        uint32_t fw0_version; /*!< "To be defined" */
        uint32_t fw0_corw_count; /*!< "To be defined" */
        uint32_t fw1_size; /*!< "To be defined" */
        uint16_t fw1_crc16; /*!< "To be defined" */
        uint32_t fw1_version; /*!< "To be defined" */
        uint32_t fw1_corw_count; /*!< "To be defined" */
        uint32_t fw2_size; /*!< "To be defined" */
        uint16_t fw2_crc16; /*!< "To be defined" */
        uint32_t fw2_version; /*!< "To be defined" */
        uint32_t fw2_corw_count; /*!< "To be defined" */
        isis_aocs__scg_fw_error_t bitmap1; /*!< "To be defined" */
    } fields;
...
typedef union __attribute__((__packed__)) _isis_aocs__scg_get_system_output__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        isis_aocs__generic_error_code_t error_code; /*!< Result code */
        isis_aocs__scg_reply_header_t reply_header; /*!< "To be defined" */
        isis_aocs__scg_gyro_output_t gyro_output; /*!< "To be defined" */
        isis_aocs__scg_gyro_temp_calib_t gyro_temp_calib; /*!< "To be defined" */
        isis_aocs__scg_gyro_misa_calib_t gyro_misa_calib; /*!< "To be defined" */
        isis_aocs__scg_ugakf_rate_t ugakf_rate; /*!< "To be defined" */
        isis_aocs__scg_ugakf_bias_t ugakf_bias; /*!< "To be defined" */
        int8_t mcu_temp; /*!< "To be defined" */
        int8_t gyro1_temp_raw; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
        int8_t gyro2_temp_raw; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
        int8_t gyro3_temp_raw; /*!< "To be defined" \note conversion: eng. value [in °C] = -1 * raw + 25*/
    } fields;
...
/*!
 * Union for storing the parameters sent by set_control_target.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_control_target__to_t
{
...
} isis_aocs__set_control_target__to_t;

/*!
 * Structure the parameters sent by set_control_target_for_modes.
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_control_target_for_modes__to_t
{
...
/*!
 * Union for storing the parameters sent by set_control_target_gsr.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_control_target_gsr__to_t
{
    unsigned char raw[41];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_control_target_gsr__to_t;

/*!
 * Union for storing the parameters sent by set_control_target_lvlh.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_control_target_lvlh__to_t
{
    unsigned char raw[12];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_control_target_lvlh__to_t;

/*!
 * Union for storing the parameters sent by set_control_target_quat.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_control_target_quat__to_t
{
    unsigned char raw[16];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_control_target_quat__to_t;

/*!
 * Union for storing the parameters sent by set_control_target_spin.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_control_target_spin__to_t
{
    unsigned char raw[34];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_control_target_spin__to_t;
...
/*!
 * Union for storing the parameters sent by set_param_auriga.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_auriga__to_t
{
    unsigned char raw[4];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_param_auriga__to_t;
...
typedef union __attribute__((__packed__)) _isis_aocs__set_param_gnss_log_config__to_t
{
    ...
    {
        isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
        uint16_t entry; /*!< Log entry in the parameter to write to \note conversion: eng. value = 0.142857142857143 * raw */
        uint8_t size; /*!< Size of the data to write to the parameter */
        isis_aocs__novatel_msg_id_t msg_id; /*!< Message ID */
        isis_aocs__novatel_trigger_type_t trigger : 3; /*!< Message trigger */
        uint8_t padding : 2; /*!< Padding bits */
        isis_aocs__novatel_msg_type_t msg_type : 2; /*!< Message type */
        uint16_t period; /*!< Log period \note conversion: eng. value = 0.05 * raw */
        uint16_t offset; /*!< Log offset \note conversion: eng. value = 0.05 * raw */
    } fields;
...
/*!
 * Union for storing the parameters sent by set_param_imtq.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_imtq__to_t
{
...
} isis_aocs__set_param_imtq__to_t;
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial__to_t
{
    isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial_f__to_t
{
    isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial_generic__to_t
{
    uint32_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial_hex32__to_t
{
    isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial_int32__to_t
{
    isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__set_param_partial_uint32__to_t
{
    isis_aocs__fpdb_index_t index; /*!< Where to write the parameter */
    uint16_t offset; /*!< Byte offset in the parameter to write to */
    uint8_t size; /*!< Byte size of the data to write to the parameter */
...
/*!
 * Union for storing the parameters sent by set_param_rw25.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_rw25__to_t
{
...
} isis_aocs__set_param_rw25__to_t;

/*!
 * Union for storing the parameters sent by set_param_scg.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_scg__to_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        isis_aocs__scg_enum_onoff_t SCG_2 : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t SCG_3 : 1; /*!< "To be defined" */
        uint8_t SCG_raw_padding : 5; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t ugakf_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t temp_comp_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t misa_comp_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t swdt_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t spike_removal_enabled : 1; /*!< "To be defined" */
        isis_aocs__scg_enum_onoff_t turnon_bias_removal_enabled : 1; /*!< "To be defined" */
        uint8_t padding0 : 2; /*!< "To be defined" */
        int8_t update_rate_ugakf; /*!< "To be defined" */
        int8_t update_rate_fast; /*!< "To be defined" */
        isis_aocs__scg_enum_gyro_fullscale_t gyro_fullscale : 2; /*!< Gyroscope full-scale range */
        isis_aocs__scg_enum_onoff_t gyro_reinit_enabled : 1; /*!< Reinitialization enabled */
        uint8_t padding1 : 5; /*!< "To be defined" */
        float r_gyro1_x; /*!< "To be defined" */
        float r_gyro1_y; /*!< "To be defined" */
        float r_gyro1_z; /*!< "To be defined" */
        float r_gyro2_x; /*!< "To be defined" */
...
} isis_aocs__set_param_scg__to_t;
...
/*!
 * Union for storing the parameters sent by set_param_thr_config.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_thr_config__to_t
{
    unsigned char raw[8];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_param_thr_config__to_t;

/*!
 * Union for storing the parameters sent by set_param_thr_state_config.
 */
typedef union __attribute__((__packed__)) _isis_aocs__set_param_thr_state_config__to_t
{
    unsigned char raw[28];
    struct __attribute__ ((__packed__))
    {
...
} isis_aocs__set_param_thr_state_config__to_t;
 ...
 */
typedef struct __attribute__((__packed__)) _isis_aocs__tdd__to_t
{
    isis_aocs__tdd_command_t command; /*!< TDD command */
    uint8_t* data; /*!< "To be defined" (maximum length: 64 elements) */
...
/*!
 * Union for storing the parameters sent by update_tle.
 */
typedef union __attribute__((__packed__)) _isis_aocs__update_tle__to_t
{
    unsigned char raw[41];
    struct __attribute__ ((__packed__))
    {
