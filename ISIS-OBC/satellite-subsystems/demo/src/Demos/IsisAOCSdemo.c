...
static Boolean IsisAOCS_GetAOCSTelemetry(void)
{
   ...
   // isis_aocs__retrieve_aocs_tlm__from_t aocs_tlm = {{0}};
    ...
    retVal = isis_aocs__retrieve_current_aocs_tlm(0, &aocs_tlm);
    ...
    else
    {
        ...
        for (i = 0; i < 3; i++)
        {
            printf("\t\t MTM_INT[%u]: %f [nT]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.MTM_INT[i]);
            printf("\t\t MTM_EXT[%u]: %f [nT]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.MTM_EXT[i]);
            printf("\t\t SCG_RAW[%u]: %f [rad/s]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.SCG_RAW[i]);
            printf("\t\t SCG_FILT[%u]: %f [rad/s]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.SCG_FILT[i]);
        ...
        for (i = 0; i < 3; i++)
        {
            printf("\t\t position[%u]: %f [m]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.GNSS.fields.position[i]);
            printf("\t\t velocity[%u]: %f [m/s]\n\r", i, aocs_tlm.fields.measurements.fields.measurements.fields.GNSS.fields.velocity[i]);
        }
        printf("\t Processed sensor data: \n\r");
        for (i = 0; i < 3; i++)
        {
            printf("\t\t MTM_INT[%u]: %f \n\r", i, aocs_tlm.fields.processed_sensor_data.fields.MTM_INT[i]);
            printf("\t\t MTM_EXT[%u]: %f \n\r", i, aocs_tlm.fields.processed_sensor_data.fields.MTM_EXT[i]);
            printf("\t\t CSS[%u]: %f \n\r", i, aocs_tlm.fields.processed_sensor_data.fields.CSS[i]);
            printf("\t\t SCG_RAW[%u]: %f \n\r", i, aocs_tlm.fields.processed_sensor_data.fields.SCG_RAW[i]);
            printf("\t\t SCG_FILT[%u]: %f \n\r", i, aocs_tlm.fields.processed_sensor_data.fields.SCG_FILT[i]);
...
void get_imtq_tlm(void)
{
    ...
    printf("\t V_D: %u mV \n\r", response.fields.tlm.fields.imtq.fields.V_D);
    printf("\t V_A: %u mV \n\r", response.fields.tlm.fields.imtq.fields.V_A);
    printf("\t I_D: %u * 0.1 mA \n\r", response.fields.tlm.fields.imtq.fields.I_D);
    printf("\t I_A: %u * 0.1 mA \n\r", response.fields.tlm.fields.imtq.fields.I_A);
    for (i = 0; i < 3; i++)
    {
        printf("\t I_C[%u]: %i * 0.1 mA \n\r", i, response.fields.tlm.fields.imtq.fields.I_C[i]);
...
void get_scg_tlm(void)
{
    ...
    printf("\t gyro1_temp: %i \n\r", response.fields.tlm.fields.scg.fields.gyro1_temp);
    printf("\t gyro2_temp: %i \n\r", response.fields.tlm.fields.scg.fields.gyro2_temp);
    printf("\t gyro3_temp: %i \n\r", response.fields.tlm.fields.scg.fields.gyro3_temp);
    printf("\t current: %u mA \n\r", response.fields.tlm.fields.scg.fields.current);
    printf("\t voltage: %u mV \n\r", response.fields.tlm.fields.scg.fields.voltage);
...
void get_rw_tlm(void)
{
	...
	isis_aocs__retrieve_current_aocs_tlm(0, &response);
...
void get_gnss_tlm(void)
{
    ...
    printf("\t\t temperature_2: %u C\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.temperature_2);
    printf("\t\t antenna_current: %u mA\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.antenna_current);
    printf("\t\t antenna_voltage: %u mV\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.antenna_voltage);
    printf("\t\t core_voltage: %u mV\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.core_voltage);
    printf("\t\t supply_voltage: %u mV\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.supply_voltage);
    printf("\t\t voltage_1v8: %u mV\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.voltage_1v8);
    printf("\t\t peripheral_voltage: %u mV\n\r", response.fields.tlm.fields.gnss.fields.hwmonitor.fields.peripheral_voltage);
