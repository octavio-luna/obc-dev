...
///
///		rv = isis_mtq_v2__getParameter(0, param_id, &param_val, &rsp_stat);
///
...
///
///		rv = isis_mtq_v2__setParameter(0, param_id, &param_inp, &param_outp &rsp_stat);
///
...
///
///		rv = isis_mtq_v2__setParameter(0, param_id, barr_inp, &param_outp, &rsp_stat);
///
...
static void _parse_selftest_step(isis_mtq_v2__selftestdata_t *p_step)
{
	...
	{
	case isis_mtq_v2__step__init: printf(" ( init ) \r\n"); break;
	case isis_mtq_v2__step__x_positive: printf(" ( +x ) \r\n"); break;
	case isis_mtq_v2__step__x_negative: printf(" ( -x ) \r\n"); break;
	case isis_mtq_v2__step__y_positive: printf(" ( +y ) \r\n"); break;
	case isis_mtq_v2__step__y_negative: printf(" ( -y ) \r\n"); break;
	case isis_mtq_v2__step__z_positive: printf(" ( +z ) \r\n"); break;
	case isis_mtq_v2__step__z_negative: printf(" ( -z ) \r\n"); break;
	case isis_mtq_v2__step__fina: printf(" ( fina ) \r\n"); break;
	default: printf(" ( !UNKNOWN! ) \r\n"); break;
	}

	printf(" \t raw_magf(x,y,z) = %ld, %ld, %ld [-] \r\n", p_step->fields.raw_mag_x, p_step->fields.raw_mag_y, p_step->fields.raw_mag_z);
	printf(" \t cal_magf(x,y,z) = %ld, %ld, %ld [10E-9 T] \r\n", p_step->fields.calibrated_mag_x, p_step->fields.calibrated_mag_y, p_step->fields.calibrated_mag_z);
...
static Boolean _startSelfTest(Boolean info)
{
	...
	if(info)
	{
		...
		printf(" Provide isis_mtq_v2__axis___all (%d) to actuate and verify all axes-directions (i.e. a positive and a negative dipole generated per axis) \r\n", isis_mtq_v2__axis__all);
...
static Boolean _getSystemState(Boolean info)
{
	...
	{
	case isis_mtq_v2__mode__idle: printf("( idle ) \r\n"); break;
	case isis_mtq_v2__mode__selftest: printf("( selftest ) \r\n"); break;
	case isis_mtq_v2__mode__detumble: printf("( detumble ) \r\n"); break;
	default: printf("( !UNKNOWN! ) \r\n"); break;
	}
