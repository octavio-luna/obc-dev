...
#include <satellite-subsystems/gom_eps.h>

#include <hal/errors.h>

static Boolean EPS_TelemetryHKbasic(void)
{
    gom_eps__get_hk_2_basic__from_t myEpsTelemetry_hk_basic;

	printf("\r\nEPS Telemetry HK basic \r\n\n");
	print_error(gom_eps__get_hk_2_basic(0, &myEpsTelemetry_hk_basic));

	printf("Number of EPS reboots = %d \r\n", (unsigned int)myEpsTelemetry_hk_basic.fields.counter_boot);
	...
	printf("PPT tracker Mode = %d\r\n", myEpsTelemetry_hk_basic.fields.pptmmode);
	printf(" \r\n");
...
{
    gom_eps__get_hk_2_wdt__from_t myEpsTelemetry_hk_wdt;

	printf("\r\nEPS Telemetry HK wdt \r\n\n");
	print_error(gom_eps__get_hk_2_wdt(0, &myEpsTelemetry_hk_wdt));

	printf("Time left on I2C WDT = %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields.wdt_i2c_time_left);
	printf("Time left on I2C WDT GND = %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields. wdt_gnd_time_left);
	...
	printf("Number of WDT I2C reboots = %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields.counter_wdt_i2c);
	printf("Number of WDT GND reboots = %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields.counter_wdt_gnd);
	printf("Number of WDT CSP reboots ping 1= %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields.counter_wdt_csp[0]);
	printf("Number of WDT CSP reboots ping 2= %d \r\n", (unsigned int)myEpsTelemetry_hk_wdt.fields.counter_wdt_csp[1]);
	printf(" \r\n");
...
{
    gom_eps__get_hk_2_out__from_t myEpsTelemetry_hk_out;

	printf("\r\nEPS Telemetry HK out \r\n\n");
	print_error(gom_eps__get_hk_2_out(0, &myEpsTelemetry_hk_out));

	printf("Current outputs current 1 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[0]);
	printf("Current outputs current 2 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[1]);
	printf("Current outputs current 3 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[2]);
	printf("Current outputs current 4 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[3]);
	printf("Current outputs current 5 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[4]);
	printf("Current outputs current 6 = %d mA\r\n", myEpsTelemetry_hk_out.fields.currout[5]);
...
{
    gom_eps__get_hk_2_vi__from_t myEpsTelemetry_hk_vi;

	printf("\r\nEPS Telemetry HK vi \r\n\n");
	print_error(gom_eps__get_hk_2_vi(0, &myEpsTelemetry_hk_vi));
	...
	printf("Current inputs current 1 = %d mA\r\n", myEpsTelemetry_hk_vi.fields.currin[0]);
	printf("Current inputs current 2 = %d mA\r\n", myEpsTelemetry_hk_vi.fields.currin[1]);
	printf("Current inputs current 3 = %d mA\r\n", myEpsTelemetry_hk_vi.fields.currin[2]);
...
{
	gom_eps__get_hk_2__from_t myEpsTelemetry_hk;

	printf("\r\nEPS Telemetry HK General \r\n\n");
	print_error(gom_eps__get_hk_2(0, &myEpsTelemetry_hk));
	...
	printf("Current inputs current 1 = %d mA\r\n", myEpsTelemetry_hk.fields.currin[0]);
	printf("Current inputs current 2 = %d mA\r\n", myEpsTelemetry_hk.fields.currin[1]);
	printf("Current inputs current 3 = %d mA\r\n", myEpsTelemetry_hk.fields.currin[2]);

	printf("Current from boost converters = %d mA\r\n", myEpsTelemetry_hk.fields.cursun);
	printf("Current out of the battery = %d mA\r\n", myEpsTelemetry_hk.fields.cursys);

	printf("Current outputs current 1 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[0]);
	printf("Current outputs current 2 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[1]);
	printf("Current outputs current 3 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[2]);
	printf("Current outputs current 4 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[3]);
	printf("Current outputs current 5 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[4]);
	printf("Current outputs current 6 = %d mA\r\n", myEpsTelemetry_hk.fields.currout[5]);
	...
	printf("Time left on I2C WDT = %d \r\n", (unsigned int)myEpsTelemetry_hk.fields.wdt_i2c_time_left);
	printf("Time left on WDT GND = %d \r\n", (unsigned int)myEpsTelemetry_hk.fields. wdt_gnd_time_left);
	printf("Time left on I2C WDT CSP ping 1 = %d \r\n", myEpsTelemetry_hk.fields.wdt_csp_pings_left[0]);
	printf("Time left on I2C WDT CSP ping 2 = %d \r\n", myEpsTelemetry_hk.fields.wdt_csp_pings_left[1]);

	printf("Number of I2C WD reboots = %d\r\n", (unsigned int)myEpsTelemetry_hk.fields.counter_wdt_i2c);
	printf("Number of WDT GND reboots = %d\r\n", (unsigned int)myEpsTelemetry_hk.fields.counter_wdt_gnd);
	printf("Number of WDT CSP ping 1 reboots = %d\r\n", (unsigned int)myEpsTelemetry_hk.fields.counter_wdt_csp[0]);
	printf("Number of WDT CSP ping 2 reboots = %d\r\n", (unsigned int)myEpsTelemetry_hk.fields.counter_wdt_csp[0]);
	printf("Number of EPS reboots = %d\r\n", (unsigned int)myEpsTelemetry_hk.fields.counter_boot);
	...
	printf("PPT tracker Mode = %d\r\n", myEpsTelemetry_hk.fields.pptmmode);
	printf(" \r\n");
...
{
    gom_eps__get_hk_1__from_t myEpsTelemetry_param;

	printf("\r\nEPS Telemetry HK Param \r\n\n");
	print_error(gom_eps__get_hk_1(0, &myEpsTelemetry_param));
	...
	printf("Temperature Converter 1 = %d C \r\n", myEpsTelemetry_param.fields.tempConverter[0]);
	printf("Temperature Converter 2 = %d C \r\n", myEpsTelemetry_param.fields.tempConverter[1]);
	printf("Temperature Converter 3 = %d C \r\n", myEpsTelemetry_param.fields.tempConverter[2]);
	...
	printf("Number of Software Errors = %d \r\n", myEpsTelemetry_param.fields.sw_errors);

	printf("PPT Mode = %d \r\n", myEpsTelemetry_param.fields.ppt_mode);

	printf("Status 5V Channel 1 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel5V_1);
	printf("Status 5V Channel 2 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel5V_2);
	printf("Status 5V Channel 3 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel5V_3);
	printf("Status 3.3V Channel 1 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel3V3_1);
	printf("Status 3.3V Channel 2 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel3V3_2);
	printf("Status 3.3V Channel 3 = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.channel3V3_3);
	printf("Status QuadBatt switch = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.quadbatSwitch);
	printf("Status QuadBatt heater = %d \r\n", myEpsTelemetry_param.fields.channel_status.fields.quadbatHeater);
...
static Boolean EPS_SetOutputOn(void)
{
    ...
    if(selection != 6)
    {
        gom_eps__set_single_output__to_t channel_params = {.fields = {.channel = selection, .value = gom_eps__mode__on, .delay = 0}};
        print_error(gom_eps__set_single_output(0, &channel_params));
    }
...
static Boolean EPS_SetOutputOff(void)
{
    ...
    if(selection != 6)
    {
        gom_eps__set_single_output__to_t channel_params = {.fields = {.channel = selection, .value = gom_eps__mode__off, .delay = 0}};
        print_error(gom_eps__set_single_output(0, &channel_params));
    }
...
static Boolean EPS_Reboot(void)
{
    ...
    {
    case 0:
    	(void)gom_eps__reboot(0);
    	break;
    case 1:
    	(void)gom_eps__hard_reset(0);
    	break;
    }
...
static Boolean EPS_TelemetryHKGeneral_BatteryLoop(void)
{
    ...
    {
        gom_eps__get_hk_2__from_t data;
    	int rv;

    	if(i++ % 60 == 0)						// every 60 steps we'll do stuff
    	{
			rv = gom_eps__get_hk_2(0, &data);
			if(rv)
			{
			...
			else
			{
				...
				printf("boost[PV%d] - V: %dmV, C: %dmA, T: %ddegC | batt - V: %dmV, C[cursun]: %dmA, C[cursys]: %dmA, T: %ddegC, mode: %s \n\r",
						GOMEPS_BAT_CHARGE_CONVERTER_IDX+1, data.fields.vboost[GOMEPS_BAT_CHARGE_CONVERTER_IDX], data.fields.currin[GOMEPS_BAT_CHARGE_CONVERTER_IDX], data.fields.temp[GOMEPS_BAT_CHARGE_CONVERTER_IDX],
...
{
    GOM_EPS_t myGOM_EPS = {.i2cAddr = 0x02};
    int rv;

	rv = GOM_EPS_Init(&myGOM_EPS, 1);
